...
void drawCorridor()
{
    drawSection(0.086,0.125,0.259,0.035,0.220,0.518);
    glPushMatrix();
			glRotatef(180.,0.,1.,0.);
			drawSection(0.086,0.125,0.259,0.035,0.220,0.518);
	glPopMatrix();
    glPushMatrix();
        glTranslatef(0.,-4.,0.);
        drawSection(0.004,0.020,0.16,0.071,0.160,0.404);
        glPushMatrix();
			glRotatef(180.,0.,1.,0.);
			drawSection(0.004,0.020,0.16,0.071,0.160,0.404);
	    glPopMatrix();
        glTranslatef(0.,-4.,0.);
        drawSection(0.004,0.011,0.060,0.078,0.117,0.254);
        glPushMatrix();
			glRotatef(180.,0.,1.,0.);
			drawSection(0.004,0.011,0.060,0.078,0.117,0.254);
	    glPopMatrix();
        glTranslatef(0.,-4.,0.);
        drawSection(0.,0.,0.,0.004,0.020,0.16);
        glPushMatrix();
			glRotatef(180.,0.,1.,0.);
			drawSection(0.,0.,0.,0.004,0.020,0.16);
	    glPopMatrix();
